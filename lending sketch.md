...
the oracle parameters are another thing to configure but it is not as complicated as it might seem after more work done in the exponential malaise section of our docs, in Other Considerations. the main complication is paying the initial reporter enough but not having it be too expensive.

Simplest possible design doesnt allow borrowing more and allows debt repayment to reduce liquidation risk but does not change interest owed (based on original principal). no complex rates option management. just have reasonable lending terms.
