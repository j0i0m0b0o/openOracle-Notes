...
It may not be possible to have full receipt-freeness onchain. There are also challenges with preventing selective non-reveal from becoming a strategic weapon. In order to preserve the lack of knowledge of the other's report in the classic prisoner game, we want a scheme where, during a live window, a participant cannot provide binding evidence of their true report, but after a delay the protocol can verify unanimity versus disagreement. The "live window" for binding evidence prevention may need to include the entire game from start to unanimity. The lack of knowledge dynamic isn't preserved otherwise. Maybe it isn't possible to do this without introducing something trusted.

Overall, the game is extremely strange and might not work. Maybe the continuation dynamic is too knife-edge between good reporting and exponential clown world blowups. Also it's certainly possible the schelling point has nothing to do with ground truth.

A haywire continuation game (exponential clown world blowup) may not be fatal. There can be nasty continuation structure yet the game finalizes on ground truth. In principle, continuation value from the reward growing each round can attract an extreme amount of capital by the time unanimity is reached, which may incentivize an ecosystem fork.
